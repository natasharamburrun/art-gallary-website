    ...
    return (
      <section className='homepage'>
        <div className="homepage__hero">
          <div className="homepage__hero-image" role="img" aria-label="Image of two people looking at a portrait in a gallery"></div>
          <div className="homepage__hero-banner">
            ...
            <div className='homepage__hero-text-and-button'>
        ...
        <div className="homepage__content">
          ...
          <footer>
            <div className="homepage__footer">
              ...
              <p className='homepage__footer-text'> The Modern Art Gallery is free to all visitors and open seven days a week 
                from 8am to 9pm. Find us at 99 King Street, Newport, USA.
              </p>
              <div className='homepage__socials'>
                <a href="https://www.google.com/" aria-label="Icon to navigate to the facebook social media page"> 
                  <svg className='homepage__icon' width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18.896 0H1.104C.494 0 0 .494 0 1.104v17.793C0 19.506.494 20 1.104 20h9.58v-7.745H8.076V9.237h2.606V7.01c0-2.583 1.578-3.99 3.883-3.99 1.104 0 2.052.082 2.329.119v2.7h-1.598c-1.254 0-1.496.597-1.496 1.47v1.928h2.989l-.39 3.018h-2.6V20h5.098c.608 0 1.102-.494 1.102-1.104V1.104C20 .494 19.506 0 18.896 0Z" fill="#FFF"/>
                  </svg>
                </a>
                <a href="https://www.google.com/" aria-label="Icon to navigate to the instagram social media page"> 
                <svg className='homepage__icon' width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://www.google.com/" aria-label="Click on this icon to navigate to the twitter social media page"> 
                <svg className='homepage__icon' width="20" height="17" xmlns="http://www.w3.org/2000/svg">
